...
@Properties({ 
		@Property(name = "sling.servlet.paths", value = { "/reportSpotRemove" }),
		})

public class removeSpotFromUi extends SlingAllMethodsServlet {
	@Reference
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)throws ServletException, IOException {
		...
		removeSpotNode(session, subNodeName, out);
