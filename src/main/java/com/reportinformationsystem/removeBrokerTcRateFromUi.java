...
@Properties({ 
		@Property(name = "sling.servlet.paths", value = { "/reportBrokerTcRateRemove" }),
		})

public class removeBrokerTcRateFromUi extends SlingAllMethodsServlet {
	@Reference
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)throws ServletException, IOException {
		...
		removeBrokerTcRateNode(session, subNodeName, out);
...
//			e.printStackTrace(out);
	...
	public static void removeBrokerTcRateNode(Session session, String subNodeName, PrintWriter out) throws PathNotFoundException, RepositoryException{
		...
		if(TCReports.hasNode("BrokerTCRate")){
			Tonnage=TCReports.getNode("BrokerTCRate");
		}
