...
@Properties({ 
		@Property(name = "sling.servlet.paths", value = { "/reportTonnageRemove" }),
		})

public class removeTonnageFromUi extends SlingAllMethodsServlet {
	@Reference
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)throws ServletException, IOException {
		...
		removeTonnageNode(session, subNodeName, out);
