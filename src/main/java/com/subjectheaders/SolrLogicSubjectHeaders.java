    ...
    //  System.out.println(q);
		...
		try {
           ...
           // q=q.toUpperCase();
			...
			url = "http://35.231.163.191:8983/solr/subject_data/select?fl=score,Key,value&defType=dismax&mm=1&pf=q&&q=value_str:("+q+")&&qf=value_str";
			//url = "http://35.231.163.191:8983/solr/subject_data/select?fl=score,Key,value&defType=dismax&mm=1&pf=q&&q=value:("+q+")&&qf=value";
			//url = "http://35.231.163.191:8983/solr/subject_data/select?q=value_str:{!dismax}"+q +"&qf=value^1 Key^1";
